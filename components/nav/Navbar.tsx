  ...
  return (
    <>
      <nav className="shadow-sm bg-gradient-to-r from-[#04091E] to-[#00D0CC] fixed w-full z-10">
        <div className="max-w-[1200px] mx-auto px-8 md:px-12 flex items-center h-20 w-full justify-between">
          <Link href="/">
            <Image
              src={logo}
          ...
          <form className="relative hidden lg:block">
            ...
            <input
              ...
              className="p-3 pl-14 md:text-md font-regular placeholder:text-sm
                     ...
                     md:w-[300px] lg:w-[320px] bg-gradient-to-r from-gray-500 to-gray-500 text-white
                     md:top-0"
            />
          </form>
          {/* w-full */}

          <div className="hidden w-[600px]  justify-between md:flex">
        ...
        >
          {(ref) => (
            ...
            <div className="md:hidden id=mobile-menu">
              <div
                ref={ref}
                className="bg-gradient-to-r from-[#04091E] to-[#00D0CC] px-6 pt-10 pb-3 space-y-8 -top-3 sm:px-3"
              >
          ...
          <div className="flex items-center h-20 w-full">
            ...
            <div className="flex items items-center mx-20 justify-between w-full">
              ...
              <div className="relative hidden md:block">
                <form className="absolute md:static top-10 -left-20 ">
                  <button
                    className="absolute md:left-4 left-6 top-3 pl-1 
                     text-2xl text-white"
                  >
              ...
              md - medium device on mobile device, it will display this div as
              block
